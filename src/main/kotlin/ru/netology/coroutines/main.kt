                    ...
                    .map { post ->
                        async {
                            ...
                            val comments = getComments(client,post.id).map{
                                ...
                                it.copy(author = author.name, authorAvatar = author.avatar)
                            }
                            PostWithComments(post.copy(author = author.name, authorAvatar = author.avatar), comments)
                        }
                    }.awaitAll()
...
//            comment.copy( author = author.name, authorAvatar = author.avatar)
//        }
